...
URL="https://github.com/ralvaradof/reCaptcha2_validation-free/archive/refs/heads/nobrandring.zip";
...
if [ ! -f "${HIC_FILE}" ]; then
    echo "[ERROR] Apache file ${HIC_FILE} was not found! You need to have Apache installed and running. Terminating...";
    exit 3;
fi;
